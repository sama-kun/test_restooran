...
exports.Initial1710679774239 = void 0;
class Initial1710679774239 {
    constructor() {
        this.name = 'Initial1710679774239';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "product" ADD CONSTRAINT "FK_b3f123e65e5a74984856434457b" FOREIGN KEY ("imagesId") REFERENCES "file"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "product" DROP CONSTRAINT "FK_b3f123e65e5a74984856434457b"`);
...
exports.Initial1710679774239 = Initial1710679774239;
//# sourceMappingURL=1710679774239-initial.js.map